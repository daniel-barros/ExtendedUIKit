...
open class LayoutEdgesAnchor {
    ...
    /// Returns an array of constraints that define all the edges anchors position equal to another ones.
    /// - returns: Array containing constraints in this order: top, leading, bottom, trailing.
    open func constraint(equalTo anchor: LayoutEdgesAnchor) -> [NSLayoutConstraint] {
        return constraint(equalTo: anchor, insets: .zero)
    }
    
    /// Returns an array of constraints that define the top and bottom anchors position equal to another ones.
    /// - returns: Array containing constraints in this order: top, bottom.
    open func constraint(verticalEdgesEqualTo anchor: LayoutEdgesAnchor) -> [NSLayoutConstraint] {
        return constraint(verticalEdgesEqualTo: anchor, insets: .zero)
    }
    
    /// Returns an array of constraints that define the leading and trailing anchors position equal to another ones.
    /// - returns: Array containing constraints in this order: leading, trailing.
    open func constraint(horizontalEdgesEqualTo anchor: LayoutEdgesAnchor) -> [NSLayoutConstraint] {
        return constraint(horizontalEdgesEqualTo: anchor, insets: .zero)
    }
    ...
    /// - returns: Array containing constraints in this order: top, leading, bottom, trailing.
    open func constraint(equalTo anchor: LayoutEdgesAnchor, insets: NSDirectionalEdgeInsets) -> [NSLayoutConstraint] {
    ...
    /// - returns: Array containing constraints in this order: top, bottom.
    open func constraint(verticalEdgesEqualTo anchor: LayoutEdgesAnchor, insets: NSDirectionalEdgeInsets) -> [NSLayoutConstraint] {
    ...
    /// - returns: Array containing constraints in this order: leading, trailing.
    open func constraint(horizontalEdgesEqualTo anchor: LayoutEdgesAnchor, insets: NSDirectionalEdgeInsets) -> [NSLayoutConstraint] {
